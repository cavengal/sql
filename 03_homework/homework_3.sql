...
SELECT c.customer_last_name, c.customer_first_name, SUM(cost_to_customer_per_qty*quantity) AS Total_Customer_Spend
FROM customer c
...
SELECT customer_id, strftime('%m',market_date) AS month, strftime('%Y',market_date) AS year, SUM(cost_to_customer_per_qty*quantity) AS Total_Customer_Spend
FROM customer_purchases
